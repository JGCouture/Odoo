odoo.define('bista_website_partial_payment.payment_form', function(require) {
"use strict";
...
PaymentForm.include({
  ...
  payEvent: function (ev) {
        ...
        var advance_payment = this.$('input#advance_payment').val();
        var self = this;
        if (ev.type === 'submit') {
        ...
        if (checked_radio.length === 1) {
            ...
            if (this.isNewPaymentRadio(checked_radio)) {
                ...
                inputs_form.toArray().forEach(function (element) {
                    ...
                    console.log("!!! element111", element.dataset, element.value);
