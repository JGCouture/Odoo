...
class Stockmove_inherit(models.Model):
    ...
    def _update_reserved_quantity(self, need, available_quantity, location_id, lot_id=None, package_id=None, owner_id=None, strict=True):
        ...
        if self._context.get('from_sale') == True :
            ...
            return super(Stockmove_inherit, self)._update_reserved_quantity(need, available_quantity, location_id, lot_id=lot_id, package_id=package_id, owner_id=owner_id, strict=strict)
...
class Stockquant_inherit(models.Model):
    ...
    def _gather(self, product_id, location_id, lot_id=None, package_id=None, owner_id=None, strict=False):
        if self._context.get('from_sale') == True :
            ...
            return super(Stockquant_inherit,self)._gather(product_id, location_id, lot_id=lot_id, package_id=package_id, owner_id=owner_id, strict=strict)
