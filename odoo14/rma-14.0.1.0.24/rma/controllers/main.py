...
class CustomerPortal(CustomerPortal):
    ...
    def rma_retun_product(self, order_line):
        ...
        reasons_objs = rma_reason.sudo().search([("is_enable_on_web","=",True), ('company_id','=',sale_order_line_obj.order_id.company_id.id)])
        return request.env.ref('rma.wk_product_return')._render({
    ...
    def rma_view(self, order_line):
        ...
        return request.env.ref('rma.wk_rma_view')._render({
            'wk_rma': rma_obj,
