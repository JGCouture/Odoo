    ...
    models.PosModel = models.PosModel.extend({
            ...
            if (this.useBlackBoxBe() && order) {
                ...
                try {
                    ...
                    await Gui.showPopup('ErrorPopup',{
                        ...
                        'body':  _t("Failed to push order: " + err.status),
                    });
                    return Promise.reject({code:999, message:'Blackbox Error', data:{order: order}});
                }
            } else {
        ...
        push_order_to_blackbox: async function(order) {
            ...
            var data = {
                ...
                'insz_or_bis_number': '00000000097',
        ...
        set_data_for_push_order_from_blackbox: function(order, data) {
            ...
            order.blackbox_ticket_counters = data.value.ticket_counter;
